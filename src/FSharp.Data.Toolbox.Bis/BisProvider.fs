    ...
    let createTypes () =        
        ...
        datasetProvider.DefineStaticParameters([ProvidedStaticParameter("pathToBisFile", typeof<string>)], fun typeName args ->
            ...
            let filterProvider =
                ...
                let getFilterMeth = ProvidedMethod(methodName = "Get", 
                                                   parameters = [ProvidedParameter("pathToBisFile", typeof<string>, optionalValue = "")], 
                                                   returnType = typeof<Observation list>,
